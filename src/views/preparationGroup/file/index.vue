<template>
    <div class="preparation-file" :title="fileInfo.fileName">
        ...
        <div class="file-info">
            <p class="file-name"><span class="ellipsis">{{ fileInfo.fileName }}</span><span style="flex-shrink: 0;">{{`.${fileInfo.fileExtension || fileInfo.extention || fileInfo.Extention}`}}</span></p>

        ...
        <div class="operation" v-if="!flag">
            ...
            <template v-else>
                ...
                <div v-show="data.Type !== 20" @click.stop="handleItem(7)">
                    ...
                    保存模板
                    <el-popover placement="right-start" :width="222" trigger="click" effect="dark" class="tips-popover" :teleported="true">
                        <template #reference>
                            <img src="@/assets/edit/icon_wenti.png" alt="" style="margin-left:4px" @click.prevent/>
                        </template>
                        <div class="tips">
                            <div class="title">
